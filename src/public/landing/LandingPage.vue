...
export default {
  ...
  data() {
    return {
      ...
      introList: [
        {title: "Контроль выполнения работ", text: "Наблюдайте за ходом работ дистанционно. Узнавайте о прогрессе выполнения из плана графика, согласованного с исполнителем", imageName: "/assets/intro3.png", href: ""},
        {title: "Контроль выполнения работ", text: "Наблюдайте за ходом работ дистанционно. Узнавайте о прогрессе выполнения из плана графика, согласованного с исполнителем", imageName: "/public/landing/images/intro3.png", href: ""},
